...
test(`@web Client App login - ${data.productName}`, async ({page}) => {
    ...
    await loginPage.validLogin(data.usrName, data.passwd);
    ...
    await placeOrder.placeOrder(data.usrName);
...
customtest(`Client App login`, async ({page, testDataForOrder}) => {
    ...
    const loginPage = poManager.getLoginPage();
    await loginPage.goTo();
    await loginPage.validLogin(testDataForOrder.usrName, testDataForOrder.passwd);
